...
export default function CalculationDetailsPopup({ open, onClose, values }: CalculationDetailsPopupProps) {
  ...
  <div>
    ...
    <div className="text-gray-500">{explanations.weight(values, breakdown)}</div>
...
{values.temperature && (
  <div>
    ...
    <div className="text-gray-500">{explanations.temperature(values, breakdown)}</div>
...
{breakdown.wbgt !== undefined && (
  <div>
    ...
    <div className="text-gray-500">{explanations.wbgt(values, breakdown)}</div>
...
{values.hoursInSun && (
  <div>
    ...
    <div className="text-gray-500">{explanations.hoursInSun(values, breakdown)}</div>
...
{values.humidity && (
  <div>
    ...
    <div className="text-gray-500">{explanations.humidity(values, breakdown)}</div>
  </div>
)}
{values.windSpeed && (
  <div>
    <strong>Wind Speed:</strong> {values.windSpeed} m/s
    <div className="text-gray-500">{explanations.windSpeed(values, breakdown)}</div>
  </div>
)}
{values.workoutType && values.workoutType !== "none" && (
  <div>
    <strong>Workout:</strong> {values.workoutType} ({values.workoutDuration} h)
    <div className="text-gray-500">{explanations.workout(values, breakdown)}</div>
...
{values.diet && (
  <div>
    ...
    <div className="text-gray-500">{explanations.diet(values, breakdown)}</div>
    {typeof values.waterFromDiet === "number" && (
