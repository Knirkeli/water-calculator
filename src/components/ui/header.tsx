export default function Header() {
    return (
        <header className="fixed top-0 left-0 flex items-center justify-between w-full mx-auto p-4 bg-blue-950 shadow-xl rounded-b-lg">
            <img src="/Vannlogo.png" alt="Water calculator logo" className="h-16 ml-6" />
            <h1 className="text-2xl font-bold text-white">Water Intake Calculator</h1>
            <nav>
